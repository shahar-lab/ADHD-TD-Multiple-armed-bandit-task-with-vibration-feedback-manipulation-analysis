...
#specific the model
f_model = accuracy ~ delta_exp_value*condition*group +(delta_exp_value*condition| subject)
...
save(model,file='./data/regression/acc~delta_exp_value*condition*group.rdata')
